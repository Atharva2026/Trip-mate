...
async def run_travel_agent(
    ...
    return {
        ...
        "hidden_places": result.get("hidden_places", []),
        "food_recommendations": result.get("food_recommendations", []),
        "culture_and_language": result.get("culture_and_language", {}),
        "budget_estimates": result.get("budget_estimates", {}),
        "safety_report": result.get("safety_report", {}),
        "photo_plan": result.get("photo_plan", []),
        "optimized_route_meta": result.get("optimized_route_meta", {}),
        "alerts": result.get("alerts", []),
        "agent_metrics": result.get("agent_metrics", []),
        "currency_data": result.get("currency_data", {}),
